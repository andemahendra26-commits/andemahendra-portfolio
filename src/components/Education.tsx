...
import educationArt from "@/assets/ascii/education.png";
    ...
    >
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <img src={educationArt} alt="" aria-hidden="true" className="dark:invert h-8 sm:h-10 md:h-12 lg:h-14 w-auto max-w-full mx-auto mb-4" />
